    ...
    <main className="bg-background relative overflow-x-hidden">
      ...
      <section className="relative pt-40 pb-16 px-6 md:px-12 lg:px-20 text-center">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <h1 className="display-font text-5xl md:text-7xl lg:text-8xl font-bold leading-[1.02] tracking-tight mb-8 text-foreground">
            About <span className="cursive-font text-[#FFB7B2] font-normal text-[1.1em]">Horizon</span>
          </h1>
      ...
      <section className="py-20 px-6 md:px-12 lg:px-20">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          <div>
            <span className="text-xs font-bold tracking-[0.2em] uppercase text-muted-foreground block mb-5">The Origin</span>
            <h2 className="display-font text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-8 leading-[1.05] text-foreground">Who We Are</h2>
            <div className="space-y-5 text-lg leading-relaxed text-muted-foreground">
              ...
              <p className="cursive-font text-2xl text-[#FFB7B2]">We are not just a clinic. We are your pet's second home.</p>
            </div>
          </div>
          <div className="relative">
            <div className="absolute -top-5 -left-5 w-full h-full bg-[#E8EFE8] card-rounded -z-10 transform rotate-2" />
            <img
              src="/assests/clinic serviice photo/Clinic Service photo2.jpg"
              alt="Clinic interior"
              className="w-full h-[560px] object-cover card-rounded soft-shadow"
            />
          </div>
        </div>
      </section>
      ...
      <section className="px-4 md:px-6 mb-20">
        <div className="max-w-7xl mx-auto bg-[#292524] text-white card-rounded py-20 px-8 md:px-14 soft-shadow-lg">
          <div className="grid lg:grid-cols-3 gap-12">
            <div>
              <span className="text-xs font-bold tracking-[0.2em] uppercase text-[#FFB7B2] block mb-5">Mission</span>
            ...
            <div>
              <span className="text-xs font-bold tracking-[0.2em] uppercase text-[#FFB7B2] block mb-5">Vision</span>
            ...
            <div>
              <span className="text-xs font-bold tracking-[0.2em] uppercase text-[#FFB7B2] block mb-5">Values</span>
      ...
      <section className="py-20 px-6 md:px-12 lg:px-20">
        <div className="max-w-7xl mx-auto">
          <h2 className="display-font text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-14 text-center text-foreground">
            The <span className="cursive-font text-[#FFB7B2] font-normal text-[1.1em]">facility</span>
          </h2>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { icon: Thermometer, title: "Examination Rooms", desc: "Modern clean spaces for thorough physical checks.", tint: "bg-[#E8EFE8]" },
              { icon: Scissors, title: "Surgical Suite", desc: "Equipped for minor and major procedures.", tint: "bg-[#EFEDF4]" },
              { icon: ShoppingBag, title: "In-house Pet Shop", desc: "Quality food, vitamins, & medical supplements.", tint: "bg-[#FFE4E1]" },
            ].map((f) => (
              <div key={f.title} className="soft-card h-72 flex flex-col justify-between">
                <div className={`w-14 h-14 pill-rounded flex items-center justify-center ${f.tint}`}>
                  <f.icon className="w-7 h-7 stroke-[1.5] text-foreground" />
                </div>
                <div>
                  <h3 className="display-font text-xl font-bold mb-3 text-foreground">{f.title}</h3>
      ...
      <section className="px-4 md:px-6 mb-20">
        <div className="max-w-7xl mx-auto bg-[#E8EFE8] card-rounded py-20 px-8 md:px-14 lg:px-20 soft-shadow">
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div>
              <h2 className="display-font text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-10 leading-[1.05] text-foreground">Visit Us</h2>
              <div className="space-y-8">
                <div>
                  <span className="text-xs font-bold tracking-[0.2em] uppercase text-muted-foreground block mb-2">Address</span>
                  <p className="text-xl md:text-2xl font-semibold text-foreground">Surkhet Road, Nepalgunj-2,<br />Banke, Nepal</p>
                </div>
                <div>
                  <span className="text-xs font-bold tracking-[0.2em] uppercase text-muted-foreground block mb-2">Contact</span>
                  <p className="text-xl md:text-2xl font-semibold text-foreground">+977-9869369273</p>
                </div>
                <div>
                  <span className="text-xs font-bold tracking-[0.2em] uppercase text-muted-foreground block mb-2">Opening Hours</span>
                  <p className="text-xl md:text-2xl font-semibold text-foreground">Mon – Sun: 8:00 AM – 8:00 PM<br /><span className="cursive-font text-xl text-[#FFB7B2]">including public holidays</span></p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto bg-[#292524] text-white card-rounded py-24 md:py-32 px-6 text-center soft-shadow-lg relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            <h2 className="display-font text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight leading-[1.05] mb-10">
              Ready For <span className="cursive-font text-[#FFB7B2] font-normal text-[1.1em]">better</span> care?
            </h2>
